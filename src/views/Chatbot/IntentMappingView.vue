<template>
  <div>
    ...
    <div id="container">
      ...
      <SideBar />
      <ManagementBoard :templateType="templateType" @open-init-modal="openInitModal" />
      <Footer />
    </div>
    <InitWarningModal @close-modal="closeModal" @okay="initData" />
  </div>
</template>

<script>
import SideBar from "@/components/AdminPage/Common/SideBar/SideBar.vue";
